...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'de.rotex.fileboxx.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'de.rotex.fileboxx.UserRole'
grails.plugins.springsecurity.authority.className = 'de.rotex.fileboxx.Role'
